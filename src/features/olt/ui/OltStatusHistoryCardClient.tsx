...
import { OltStatusHistoryCard } from '@/features/olt/ui/OltStatusHistoryCard'
...
export function OltStatusHistoryCardClient({ olt }: Props) {
  ...
  }, [olt, timeFilter, timeFilterReady])
